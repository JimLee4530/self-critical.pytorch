...
def parse_opt():
    ...
    #                 help='split')
    parser.add_argument('--checkpoint_path', type=str, default='log_top_down',
                        help='directory to store checkpointed models')
    # misc
    parser.add_argument('--id', type=str, default='top_down_mfb2',
                        help='an id identifying this run/job. used in cross-val and appended when writing progress files')
    parser.add_argument('--caption_model', type=str, default="top_down_mfb2",
