...
class DataLoader(data.Dataset):
    ...
    def reset_iterator(self, split):
        ...
        self._prefetch_process[split] = BlobFetcher(split, self, split=='train' or split=='train+val')
    ...
    def __init__(self, opt):
        ...
        print('assigned %d images to split train_val' % len(self.split_ix['train+val']))
